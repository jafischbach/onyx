...
public class PoolAttendant extends NPC {
	...
	private void convo1() {
		...
		String[] options = {
				"Nope.", 
				"Is it safe to swim here? I ask because...well...you're not wearing"
						+ " a swimsuit.",
				"Yes! Today's the day!"
		};
		getResponse(options);
	...
	private void convo2() {
		String[] options = {
				"I like water. I don't like drowning. So...no pool for me.",
	...
	private void convo3() {
		String[] options = {
				"Because, you know, you're the pool attendant?",
	...
	private void convo4() {
		Game.player.say("Yep. I'm sure.");
		convo8();
	}
	
	private void convo5() {
		String[] options = {
				"What the hell is a floaty?",
				"Uh, no. I think I'll stay dry today. Thanks."
		};
		getResponse(options);
	}
	...
	private void convo6() {
		String[] options = {
				"I mean, we're on a space station, right? I know it spins and all and there's some"
				...
				+ " in a huge blob and...well...swallow me.",
				"Yeah, okay. It's not weird at all."
		};
		getResponse(options);
	}
	...
	private void response7(int option) {
		...
		case 1:
			...
			Game.print("Miri leaves the pool area and comes back several minutes later carrying"
					+ " an inflated snowy egret. She hands it you you with a smile. It's too"
	...
	private void convo11() {
		String[] options = {
				"Are you sure?",
				"Yeah, you're right! Sometimes I get a little paranoid and think everything's"
				+ " a death trap."
		};
		getResponse(options);
	}
	...
	private void response11(int option) {
		...
		case 1:
			...
			Game.getCurrentRoom().removeNPC("miri");
			break;
		case 2:
			...
			say("Romanicus Station is the safest space station you'll ever set foot on, and"
					...
					+ ". There are no death traps here. So, do you want to swim? I can get you a"
					+ " floaty!");
			convo = 5;
			convo5();
		}
	...
	private void convo12() {
		String[] options = {
				...
				"I mean, you want me to jump in the pool so...why wouldn't you?",
				"Um...no reason."
		};
		getResponse(options);
	}
	...
	private void convo13() {
		String[] options = {
				"Well, I mean, it's a space station, so...",
				"Space sharks?",
	...
	private void convo14() {
		String[] options = {
				...
				"Okay, well, you're doing a great job. Thank you for being attentive and, er, have"
				+ " a nice day!"
		};
		getResponse(options);
	}
	...
	private void response14(int option) {
		switch(option) {
		case 1:
			say("Suntan lotion? You're funny. No, I get floaties for guests who want them. Do"
					+ " you want a floaty, "+Game.player.getName()+"?");
			convo = 5;
			convo5();
			break;
		case 2:
